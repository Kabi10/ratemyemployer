          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                By accessing or using RateMyEmployer, you agree to be bound by
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                ...
                (information or software) on RateMyEmployer's website for
                personal, non-commercial viewing only. This is the grant of a
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                RateMyEmployer reserves the right to remove or modify user
                content that violates these terms or that could harm the
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                The materials on RateMyEmployer's website are provided on an 'as
                is' basis. RateMyEmployer makes no warranties, expressed or
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                In no event shall RateMyEmployer or its suppliers be liable for
            ...
            <p>We don&apos;t tolerate harassment or discrimination.</p>
            <p>It&apos;s important to maintain professionalism.</p>
