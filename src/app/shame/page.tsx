...
import { getBottomRatedCompanies } from '@/lib/wallApi';
...
export default function WallOfShamePage() {
  ...
  useEffect(() => {
    async function fetchBottomCompanies() {
      try {
        setLoading(true);
        setError(null);
        const data = await getBottomRatedCompanies(20);
        setCompanies(data || []);
      } catch (err: any) {
        console.error('Error fetching bottom companies:', err);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-gray-600 dark:text-gray-400 mb-8">
        Lowest-rated companies based on employee reviews
      </p>
