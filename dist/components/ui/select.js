...
exports.SelectGroup = exports.SelectSeparator = exports.SelectItem = exports.SelectLabel = exports.SelectContent = exports.SelectValue = exports.SelectTrigger = exports.Select = void 0;
...
const SelectValue = React.forwardRef((_a, ref) => {
    var { className, children } = _a, props = __rest(_a, ["className", "children"]);
    return (<SelectPrimitive.Value ref={ref} className={(0, utils_1.cn)('text-sm', className)} {...props}>
    {children}
...
const SelectGroup = React.forwardRef((_a, ref) => {
    var { className, children } = _a, props = __rest(_a, ["className", "children"]);
    return (<SelectPrimitive.Group ref={ref} className={(0, utils_1.cn)('', className)} {...props}>
    {children}
